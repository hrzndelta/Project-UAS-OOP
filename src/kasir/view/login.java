...
import kasir.Theme;
import kasir.controller.LoginController;
...
public class login extends javax.swing.JFrame {
    ...
    private void applyModernTheme() {
        ...
        Theme.styleAppBackground(jPanel2);
        Theme.styleCard(jPanel1);
        Theme.styleCardAlt(jPanel3);

        jLabel1.setFont(Theme.bold(26));
        jLabel1.setForeground(Theme.TEXT);
        Theme.styleMuted(jLabel5);

        jLabel2.setFont(Theme.bold(19));
        jLabel2.setForeground(Theme.TEXT);

        Theme.styleFieldLabel(jLabel3);
        Theme.styleFieldLabel(jLabel4);
        Theme.styleField(jTextField1);
        Theme.styleField(jPasswordField1);
